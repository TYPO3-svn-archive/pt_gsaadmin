...
$LANG->includeLLFile('EXT:pt_gsaadmin/mod_taxrates/locallang.xml');
 ...
 */
require_once t3lib_extMgm::extPath('pt_gsaadmin').'mod_taxrates/class.tx_ptgsaadmin_module4.php';
...
$SOBE = t3lib_div::makeInstance('tx_ptgsaadmin_module4'); /* @var $SOBE tx_ptgsaadmin_module4 */
$SOBE->init();
