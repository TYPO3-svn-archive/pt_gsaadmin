...
***************************************************************/
/** 
 * index.php for the backend sub module 'Dispatch Cost' of the 'pt_gsaadmin' extension
 *
 * $Id: index.php,v 1.2 2008/05/02 12:38:12 ry44 Exp $
 *
...
$LANG->includeLLFile('EXT:pt_gsaadmin/mod_dispatch/locallang.xml');
 ...
 */
require_once t3lib_extMgm::extPath('pt_gsaadmin').'mod_dispatch/class.tx_ptgsaadmin_module3.php';
...
$SOBE = t3lib_div::makeInstance('tx_ptgsaadmin_module3'); /* @var $SOBE tx_ptgsaadmin_module3 */
$SOBE->init();
